...
const CommunityNewsPanel = React.forwardRef<HTMLDivElement, CommunityNewsPanelProps>(
  ({ onClose, showCloseButton = false }, ref) => {
    const { data: news, isLoading, error } = useMarketNews();

    return (
      <div ref={ref} className="h-full flex flex-col bg-card/50">
        {/* Header */}
...
CommunityNewsPanel.displayName = 'CommunityNewsPanel';

export { CommunityNewsPanel };
